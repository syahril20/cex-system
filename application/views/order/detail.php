                        ...
                        <div class="row">
                                ...
                                foreach ($images as $img):
                                    ...
                                    if (is_file($file_path)):
                                        ...
                                        <div class="col-auto mb-2">
                                            <a href="<?= htmlspecialchars($img_url) ?>" class="img-preview-link" data-bs-toggle="modal"
                                                data-bs-target="#imgPreviewModal" data-img="<?= htmlspecialchars($img_url) ?>">
                            ...
                            if (!$hasValidImage): ?>
                                <div class="col">
                                    ...
                                    <?php if (strtolower($order['status']) === 'rejected' || $user->code === 'ADMIN' || $user->code === 'SUPER_ADMIN'): ?>
