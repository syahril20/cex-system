                            ...
                            <select name="service_type" class="form-select" required>
                                ...
                                <?php if (!empty($rates)): ?>
                                    <?php foreach ($rates as $rate): ?>
                                        <option value="<?= htmlspecialchars($rate['id']) ?>"><?= htmlspecialchars($rate['text']) ?></option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        </div>
                            ...
                            <div class="shipment-detail-group col-md-12 mb-3 p-3 border rounded bg-light">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="shipment_details[0][name]" value="Jacket" class="form-control" required>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" name="shipment_details[0][qty]" value="1" class="form-control" required>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label fw-bold">Price</label>
                                        <input type="number" name="shipment_details[0][price]" value="20" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
